...
export const DEMO_TRANSACCIONES: readonly DemoTransaccionDef[] = [
  ...
  {
    descripcion: 'Restaurante Sushi Domicilio',
    cargo: 35_000n,
    abono: 0n,
    bucketKey: Bucket.Deseos,
    daysAgo: 9,
  ...
  {
    descripcion: 'Restaurante La Vecina',
    cargo: 45_000n,
    abono: 0n,
    bucketKey: Bucket.Deseos,
    daysAgo: 16,
  ...
  {
    descripcion: 'Ahorro extra fin de mes',
    cargo: 10_000n,
    abono: 0n,
    bucketKey: Bucket.Ahorro,
    daysAgo: 28,
