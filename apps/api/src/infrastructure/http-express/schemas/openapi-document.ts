...
// separate z.union schema (registrarMovimientoManualOpenApiSchema) because
// zod-openapi v5 cannot iterate the `oneOf` generated by z.discriminatedUnion.
// Both schemas produce equivalent validation behavior.
 ...
 * the `oneOf` generated by z.discriminatedUnion. Runtime validation uses
 * registrarMovimientoManualSchema (z.discriminatedUnion with .strict()) in the route.
 *
 * Both schemas produce equivalent behavior; this one documents the wire contract.
 */
  ...
  z
    .object({
      ...
      categoriaId: z
        .string()
        .describe(
          'Required for Gasto. Must belong to the calling user catalog AND map to the supplied bucket ' +
