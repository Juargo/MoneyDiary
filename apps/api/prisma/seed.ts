...
const PATRON_CATALOG: Array<{
  ...
  matchType: string;
  bucketId: string;
  // US-013 S1 (dual-write): categoriaId nace consistente con bucketId — la
  // categoría elegida SIEMPRE pertenece al mismo bucket que ya tenía el
  // patrón (CATEGORIA_BUCKET[categoria] === bucket original), para no
  // introducir drift entre las dos columnas durante la ventana S1→S2.
  categoriaId: string;
  prioridad: number;
}> = [
  // ── Necesidades (alimentos, transporte, salud, servicios básicos) ──
  { id: 'pat-lider',         patron: 'lider',          matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Necesidades], categoriaId: CATEGORIA_IDS[Categoria.Supermercado], prioridad: 10 },
  { id: 'pat-jumbo',         patron: 'jumbo',          matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Necesidades], categoriaId: CATEGORIA_IDS[Categoria.Supermercado], prioridad: 10 },
  { id: 'pat-unimarc',       patron: 'unimarc',        matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Necesidades], categoriaId: CATEGORIA_IDS[Categoria.Supermercado], prioridad: 10 },
  { id: 'pat-santa-isabel',  patron: 'santa isabel',   matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Necesidades], categoriaId: CATEGORIA_IDS[Categoria.Supermercado], prioridad: 10 },
  { id: 'pat-tottus',        patron: 'tottus',         matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Necesidades], categoriaId: CATEGORIA_IDS[Categoria.Supermercado], prioridad: 10 },
  { id: 'pat-copec',         patron: 'copec',          matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Necesidades], categoriaId: CATEGORIA_IDS[Categoria.Combustible], prioridad: 15 },
  { id: 'pat-shell',         patron: 'shell',          matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Necesidades], categoriaId: CATEGORIA_IDS[Categoria.Combustible], prioridad: 15 },
  { id: 'pat-farmacia',      patron: 'farmacia',       matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Necesidades], categoriaId: CATEGORIA_IDS[Categoria.Farmacia], prioridad: 20 },
  { id: 'pat-isapre',        patron: 'isapre',         matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Necesidades], categoriaId: CATEGORIA_IDS[Categoria.Salud], prioridad: 20 },
  { id: 'pat-transantiago',  patron: 'transantiago',   matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Necesidades], categoriaId: CATEGORIA_IDS[Categoria.Transporte], prioridad: 20 },
  { id: 'pat-bip',           patron: 'bip',            matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Necesidades], categoriaId: CATEGORIA_IDS[Categoria.Transporte], prioridad: 25 },

  // ── Deseos (entretenimiento, restaurantes, suscripciones) ──
  { id: 'pat-netflix',       patron: 'netflix',        matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Deseos], categoriaId: CATEGORIA_IDS[Categoria.Streaming], prioridad: 10 },
  { id: 'pat-spotify',       patron: 'spotify',        matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Deseos], categoriaId: CATEGORIA_IDS[Categoria.Streaming], prioridad: 10 },
  { id: 'pat-amazon-prime',  patron: 'prime video',    matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Deseos], categoriaId: CATEGORIA_IDS[Categoria.Streaming], prioridad: 10 },
  { id: 'pat-uber-eats',     patron: 'uber eats',      matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Deseos], categoriaId: CATEGORIA_IDS[Categoria.Delivery], prioridad: 15 },
  { id: 'pat-rappi',         patron: 'rappi',          matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Deseos], categoriaId: CATEGORIA_IDS[Categoria.Delivery], prioridad: 15 },

  // ── Ahorro (transferencias a fintech / ahorro / inversión) ──
  { id: 'pat-fintual',       patron: 'fintual',        matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Ahorro], categoriaId: CATEGORIA_IDS[Categoria.Ahorro], prioridad: 10 },
  { id: 'pat-bci-ahorro',    patron: 'cuenta ahorro',  matchType: 'CONTAINS',    bucketId: BUCKET_IDS[Bucket.Ahorro], categoriaId: CATEGORIA_IDS[Categoria.Ahorro], prioridad: 20 },
  // AFP abreviada en cartola: "AFP ..." — STARTS_WITH para anclar y evitar false positives
  { id: 'pat-afp',           patron: 'afp ',           matchType: 'STARTS_WITH', bucketId: BUCKET_IDS[Bucket.Ahorro], categoriaId: CATEGORIA_IDS[Categoria.Ahorro], prioridad: 15 },
  // Transferencia a cuenta propia o de ahorro: REGEX acotado
  { id: 'pat-transferencia-ahorro', patron: '^transf(?:erencia)?.*ahorro', matchType: 'REGEX', bucketId: BUCKET_IDS[Bucket.Ahorro], categoriaId: CATEGORIA_IDS[Categoria.Ahorro], prioridad: 25 },
];
...
export async function runSeed(prisma: SeedClient): Promise<void> {
  ...
  // ── US-012 + US-013 S1: Catálogo de patrones chilenos (from module-level
  // PATRON_CATALOG). Dual-write: bucketId (fuente de verdad actual, sin
  // cambio de comportamiento) + categoriaId (nuevo, S2 lo empieza a leer). ──
