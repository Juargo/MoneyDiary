...
export function MiniSemaforoTag({
  ...
  return (
    <Link
      to="/semaforo"
      search={{ periodo }}
      className={`inline-flex h-7 w-7 items-center justify-center rounded-full focus-visible:outline focus-visible:outline-2 focus-visible:outline-slate-800 ${estilo.className}`}
      onKeyDown={(event) => {
