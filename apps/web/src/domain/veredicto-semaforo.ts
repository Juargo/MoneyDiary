/**
 * Veredicto del semáforo — hero redesign (2026-08-30). Pure presentation
 ...
 * via `ETIQUETA_BUCKET`) — this module stays lib-free (domain never imports
 * `lib/`). Inconsistent data (an estadoGlobal whose buckets don't carry the
