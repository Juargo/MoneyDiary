 ...
 * - shows a bucket-colored icon badge (categoria-iconografia, PR6, MCTG-01),
 *   name, and etiquetaPatrones(n) pattern count tag
...
export function CategoriaFila({ categoria }: CategoriaFilaProps) {
  ...
  const { id, nombre, bucket, patrones, icono } = categoria;
