/**
 * palabras-de-descripcion.ts (issue #745, patrón desde movimiento mobile) —
 * ported verbatim from `apps/web/src/domain/palabras-de-descripcion.ts`.
 *
 * Pure tokenization of a transaction description into its words, keeping
 * each word's ORIGINAL char offsets. This is the building block that lets
 * the word-picking UI turn a contiguous word range back into a literal
