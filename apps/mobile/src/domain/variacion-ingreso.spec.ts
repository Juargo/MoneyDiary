...
// Income card redesign (2026-08-30): "+12% vs mes anterior" trend pill.
// Verbatim mirror of `apps/web/src/domain/variacion-ingreso.test.ts`
// (ADR-008/024 duplication discipline) — pure BigInt percent delta over the
// annual `meses` payload, rounded half away from zero; null degrades to a
// pill-less card whenever the comparison is not honestly computable.
