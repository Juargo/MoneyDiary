...
| [ADR-039](ADR-039-movimiento-manual-origen-sentinel.md) | Movimientos manuales: columna `origen`, cuenta centinela per-user y semántica de identidad de origen (enmienda premisa de ADR-026: una `Transaccion` ya no siempre nace de una `Ingesta`) | ✅ Decidido |
